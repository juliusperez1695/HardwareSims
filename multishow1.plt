...
# SETUP COMMANDS
#==============================================================================
set xlabel 'Time (s)' enhanced textcolor '#404040'
set ylabel 'Angular Velocity (rad/s)' enhanced textcolor '#404040'
...
unset rtics
unset mrtics
set key bmargin center opaque horizontal Left noinvert reverse width 0 height 1 samplen 4 spacing 1 enhanced textcolor '#404040' nobox maxrows auto maxcols auto
...
#==============================================================================
plot \
    'plot1.dat' index 0 title 'Motor Velocity' with lines linestyle 1 linewidth 2
